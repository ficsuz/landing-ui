<template>
    <div class="page-wrapper">
        <div class="page-header">
            <h1 class="page-title">Chronology (FIC History)</h1>
        ...
        <el-empty v-if="!store.loading && store.items.length === 0" description="No chronology entries yet" class="py-16" />
        ...
        <el-dialog v-model="showDialog" :title="editing ? 'Edit entry' : 'Add entry'" width="min(720px, 92vw)" top="6vh">
...
import type { Chronology, ChronologyPayload } from '@/features/chronology/types'
...
const editing = ref<Chronology | null>(null)
...
async function handleSubmit() {
    saving.value = true
    try {
        const payload: ChronologyPayload = {
            title: form.title,
