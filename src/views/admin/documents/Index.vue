        ...
        <el-table :data="store.items" v-loading="store.loading" class="w-full">
            ...
            <el-table-column label="File" width="120" align="center">
                <template #default="{ row }">
                    <el-button v-if="fileUrl(row)" type="primary" link size="small" @click="openFile(fileUrl(row))"> Open </el-button>
            ...
            <el-form label-position="top" class="flex flex-col gap-1">
                ...
                <el-form-item label="Category">
                    <el-select v-model="form.categoryId" placeholder="Select category" class="!w-full" filterable>
                        <el-option v-for="cat in categoriesStore.items" :key="cat.id" :label="resolveTranslation(cat.name)" :value="cat.id" />
                    </el-select>
                </el-form-item>
...
import type { DocumentItem, DocumentPayload } from '@/features/documents/types'
