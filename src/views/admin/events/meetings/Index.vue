<template>
    <div class="page-wrapper">
        ...
        <el-empty v-if="!loading && items.length === 0" description="No meetings available" class="py-16" />

        <el-dialog v-model="showDialog" title="Add meeting" width="560px">
            <el-form label-position="top">
                ...
                <el-form-item label="Location"><el-input placeholder="Address" /></el-form-item>
            </el-form>
            <template #footer>
