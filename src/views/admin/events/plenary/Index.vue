<template>
    <div class="page-wrapper">
        <div class="page-header">
            <h1 class="page-title">Plenara sessiyalari</h1>
        ...
        <el-empty v-if="!loading && items.length === 0" description="Plenara sessiyalari mavjud emas" class="py-16" />

        <el-dialog v-model="showDialog" title="Plenara sessiyasi qo'shish" width="560px">
