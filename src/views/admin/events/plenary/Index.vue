<template>
    <div class="page-wrapper">
        <div class="page-header">
            <h1 class="page-title">Plenary Sessions</h1>
        ...
        <el-empty v-if="!loading && items.length === 0" description="No plenary sessions available" class="py-16" />

        <el-dialog v-model="showDialog" title="Add plenary session" width="560px">
