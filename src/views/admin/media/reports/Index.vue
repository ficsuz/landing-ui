<template>
    <div class="page-wrapper">
        ...
        <el-table :data="items" v-loading="loading" class="w-full">
            ...
            <el-table-column prop="file" label="File" width="160">
                <template #default="{ row }">
                    <el-button v-if="row.file" type="primary" link size="small">Download</el-button>
        ...
        <el-empty v-if="!loading && items.length === 0" description="No reports available" class="py-16" />

        <el-dialog v-model="showDialog" title="Add report" width="560px">
            <el-form label-position="top">
                <el-form-item label="Title (UZ)"><el-input placeholder="Enter..." /></el-form-item>
                <el-form-item label="Title (RU)"><el-input placeholder="Enter..." /></el-form-item>
                <el-form-item label="Title (EN)"><el-input placeholder="Enter..." /></el-form-item>
                <el-form-item label="Date"><el-date-picker type="date" class="w-full" /></el-form-item>
                <el-form-item label="File (PDF)"><el-upload drag accept=".pdf"><div class="el-upload__text">Drop the PDF file here or <em>click to select</em></div></el-upload></el-form-item>
            </el-form>
            <template #footer>
