            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                >
                    ...
                    <div class="flex flex-col items-center px-4 pt-4 pb-5 flex-1">
                        ...
                        <p class="mt-2 text-[12px] text-[#8a94a6] text-center leading-relaxed">
                            {{ $t(`exec.${member.key}.role`) }}
                        </p>
                        <button class="mt-4 px-5 py-1.5 rounded-full border border-[#d0d5dd] text-[12px] font-semibold text-[#1a1e2e] transition-all duration-200 hover:bg-[#1a1e2e] hover:text-white hover:border-[#1a1e2e]">
