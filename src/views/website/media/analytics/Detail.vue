<template>
    <div v-loading="blogStore.loading" class="bg-white min-h-[50vh]">
        <div v-if="article" class="py-12 md:py-20">
            <div class="page-container">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <!-- Cover image -->
                    <div v-if="article.imageId" class="mt-8 rounded-2xl overflow-hidden aspect-[16/8] bg-[#eef0f4]">
                        <img
        ...
        <div v-else-if="!blogStore.loading" class="py-24 text-center text-[#8a94a6]">
            {{ $t('common.noData') }}
        </div>
    </div>
</template>
...
const article = computed(() => blogStore.current)

const htmlContent = computed(() => {
    if (!article.value?.content) return ''
    return resolveTranslation(article.value.content, locale.value)
})
